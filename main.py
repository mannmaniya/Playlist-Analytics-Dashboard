...
# --- 3. SIDEBAR FILTERS ---
st.sidebar.image("https://upload.wikimedia.org/wikipedia/commons/thumb/e/ef/Atlantic_Records_logo.svg/1200px-Atlantic_Records_logo.svg.png", width=150)
...
# Plotly expects data, x-axis, y-axis, and what to group by (color)
fig_timeline = px.line(filtered_df, x='date', y='position', color='song', 
                       title="Daily Chart Position (Lower is Better)")
fig_timeline.update_yaxes(autorange="reversed") # Reverses the Y axis so Rank 1 is at the top
